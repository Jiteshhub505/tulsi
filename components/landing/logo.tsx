...
export const Logo = ({
  ...
  return (
    <div className={cn("inline-flex items-center gap-2", className)}>
      <LogoIcon className="size-5" uniColor={uniColor} />
...
export const LogoIcon = ({
  ...
  return (
    ...
    >
      <path
        d="M12 2C15.5 4 17.2 7.1 17.2 10.3C17.2 14.1 14.5 17.4 10.7 18.2C7 19 4.2 16.5 4.2 12.8C4.2 8.1 7.9 4.3 12 2Z"
        fill={uniColor ? "currentColor" : "url(#logo-gradient)"}
      />
      <path
        d="M12 4.6V21"
        stroke={uniColor ? "currentColor" : "#1f7a63"}
        strokeWidth="1.8"
        strokeLinecap="round"
      />
      <path
        d="M12 11.2C12 11.2 14.7 11.1 17.1 9.4"
        stroke={uniColor ? "currentColor" : "#1f7a63"}
        strokeWidth="1.6"
        strokeLinecap="round"
      />
