...
const uiTranslations: Record<string, Record<Language, string>> = {
  ...
  "About Us Hero Subtitle": {
    en: "Bringing you 5000+ years of traditional Ayurvedic knowledge combined with modern science to create authentic, natural wellness solutions for everyday life.",
    hi: "दैनिक जीवन के लिए प्रामाणिक, प्राकृतिक वेलनेस समाधान बनाने के लिए आधुनिक विज्ञान के साथ 5000+ वर्षों के पारंपरिक आयुर्वेदिक ज्ञान को आप तक लाना।",
  },
  ...
  "Our Story Paragraph 1": {
    en: "TulsiVeda was founded on a profound belief that ancient Ayurvedic wisdom holds the solutions to modern health challenges. In a world filled with synthetic remedies, we recognized the need to return to nature's healing power.",
    hi: "तुलसीवेद की स्थापना इस गहरे विश्वास पर की गई थी कि प्राचीन आयुर्वेदिक ज्ञान में आधुनिक स्वास्थ्य चुनौतियों का समाधान है। सिंथेटिक उपचारों से भरी दुनिया में, हमने प्रकृति की उपचार शक्ति की ओर लौटने की आवश्यकता को पहचाना।",
  },
  "Our Story Paragraph 2": {
    en: "Our journey began when a group of Ayurvedic practitioners and research scientists came together with a shared vision: to make authentic Ayurvedic wellness accessible to everyone. We studied traditional formulations passed down through generations and validated them with modern scientific research.",
    hi: "हमारी यात्रा तब शुरू हुई जब आयुर्वेदिक डॉक्टरों और शोध वैज्ञानिकों का एक समूह एक साझा दृष्टिकोण के साथ एक साथ आया: सभी के लिए प्रामाणिक आयुर्वेदिक कल्याण सुलभ बनाना।",
  },
  "Our Story Paragraph 3": {
    en: "Today, every product we create honors the 5000-year-old Ayurvedic tradition while meeting the highest standards of quality and safety. We source only the purest herbs, test rigorously, and craft formulations that truly work.",
    hi: "आज, हमारा हर उत्पाद 5000 साल पुरानी आयुर्वेदिक परंपरा का सम्मान करता है, जबकि गुणवत्ता और सुरक्षा के उच्चतम मानकों को पूरा करता है।",
  },
  "Our Mission & Vision": { en: "Our Mission & Vision", hi: "हमारा मिशन और विज़न" },
  "Our Mission": { en: "Our Mission", hi: "हमारा मिशन" },
  "Mission Text": {
    en: "To empower individuals to achieve optimal health through authentic Ayurvedic products that are scientifically validated, sustainably sourced, and accessible to all. We make ancient wisdom a practical part of modern life.",
    hi: "प्रामाणिक आयुर्वेदिक उत्पादों के माध्यम से लोगों को इष्टतम स्वास्थ्य प्राप्त करने के लिए सशक्त बनाना जो वैज्ञानिक रूप से मान्य और टिकाऊ हों।",
  },
  "Our Vision": { en: "Our Vision", hi: "हमारा विज़न" },
  "Vision Text": {
    en: "To become the world's most trusted Ayurvedic wellness brand, recognized for unwavering commitment to quality, authenticity, and customer wellbeing. We envision natural healing as the first choice for millions worldwide.",
    hi: "गुणवत्ता, प्रामाणिकता और ग्राहक कल्याण के प्रति अटूट प्रतिबद्धता के लिए पहचाना जाने वाला दुनिया का सबसे भरोसेमंद आयुर्वेदिक ब्रांड बनना।",
  },
  "What We Stand For": { en: "What We Stand For", hi: "हमारे सिद्धांत" },
  "What We Stand For Subtitle": {
    en: "Our core values define our commitment to you and the planet",
    hi: "हमारे मूल मूल्य आपके और ग्रह के प्रति हमारी प्रतिबद्धता को परिभाषित करते हैं",
  },
  "Natural Value Desc": {
    en: "Only the purest herbs and natural ingredients. Zero harmful chemicals, zero synthetic additives.",
    hi: "केवल शुद्धतम जड़ी-बूटियाँ और प्राकृतिक घटक। शून्य हानिकारक रसायन, शून्य सिंथेटिक एडिटिव्स।",
  },
  "Scientifically Tested": { en: "Scientifically Tested", hi: "वैज्ञानिक रूप से परीक्षित" },
  "Tested Value Desc": {
    en: "Every product undergoes rigorous testing to ensure safety, efficacy, and quality standards.",
    hi: "सुरक्षा, प्रभावकारिता और गुणवत्ता मानकों को सुनिश्चित करने के लिए हर उत्पाद का कड़ा परीक्षण किया जाता है।",
  },
  "Holistic Wellness": { en: "Holistic Wellness", hi: "समग्र स्वास्थ्य" },
  "Holistic Value Desc": {
    en: "We treat the whole person through time-tested Ayurvedic principles for complete wellbeing.",
    hi: "हम संपूर्ण स्वास्थ्य के लिए समय की कसौटी पर खरे उतरे आयुर्वेदिक सिद्धांतों के माध्यम से व्यक्ति का उपचार करते हैं।",
  },
  "Certified Quality": { en: "Certified Quality", hi: "प्रमाणित गुणवत्ता" },
  "Quality Value Desc": {
    en: "Certified by health authorities and trusted by healthcare professionals worldwide.",
    hi: "स्वास्थ्य अधिकारियों द्वारा प्रमाणित और दुनिया भर में स्वास्थ्य पेशेवरों द्वारा भरोसेमंद।",
  },
  "Why Choose Ayurveda?": { en: "Why Choose Ayurveda?", hi: "आयुर्वेद क्यों चुनें?" },
  "Why Choose Ayurveda Subtitle": {
    en: "Ayurveda is not just medicine—it's a complete system of wellness that has healed millions for over 5000 years. Unlike modern treatments that often address symptoms, Ayurveda targets the root cause of imbalance.",
    hi: "आयुर्वेद केवल दवा नहीं है - यह वेलनेस की एक संपूर्ण प्रणाली है जिसने 5000 से अधिक वर्षों में लाखों लोगों को ठीक किया है। लक्षण उपचार के विपरीत, आयुर्वेद असंतुलन के मूल कारण को लक्षित करता है।",
  },
  ...
  "Purity Promise Desc": {
    en: "Every batch is tested for purity, potency, and safety. We publish certificates of analysis for complete transparency.",
    hi: "शुद्धता, शक्ति और सुरक्षा के लिए हर बैच का परीक्षण किया जाता है। हम पूर्ण पारदर्शिता के लिए विश्लेषण प्रमाण पत्र प्रकाशित करते हैं।",
  },
  "Sustainably Sourced": { en: "Sustainably Sourced", hi: "सतत रूप से प्राप्त" },
  "Source Promise Desc": {
    en: "We partner with organic farms and ethical suppliers who share our commitment to protecting the environment.",
    hi: "हम जैविक खेतों और नैतिक आपूर्तिकर्ताओं के साथ भागीदारी करते हैं जो पर्यावरण की रक्षा के लिए हमारी प्रतिबद्धता को साझा करते हैं।",
  },
  "Customer First": { en: "Customer First", hi: "ग्राहक सबसे पहले" },
  "Customer Promise Desc": {
    en: "Your satisfaction and wellbeing are our top priorities. We offer expert guidance and hassle-free returns.",
    hi: "आपकी संतुष्टि और कल्याण हमारी सर्वोच्च प्राथमिकताएँ हैं। हम विशेषज्ञ मार्गदर्शन और परेशानी मुक्त रिटर्न प्रदान करते हैं।",
  },
  ...
  "Timeline 1 Desc": {
    en: "Our roots trace back 5000+ years to ancient Ayurvedic texts and formulations that have healed generations. We honor this timeless wisdom in every product.",
    hi: "हमारी जड़ें 5000+ साल पुरानी प्राचीन आयुर्वेदिक ग्रंथों और फॉर्मूलों तक जाती हैं। हम हर उत्पाद में इस कालातीत ज्ञान का सम्मान करते हैं।",
  },
  "Timeline 2 Title": { en: "Founded with Vision (2015)", hi: "दृष्टिकोण के साथ स्थापित (2015)" },
  "Timeline 2 Desc": {
    en: "TulsiVeda was born from a mission to make authentic Ayurveda accessible to modern lifestyles. A team of practitioners and scientists joined forces.",
    hi: "तुलसीवेद का जन्म आधुनिक जीवन शैली के लिए प्रामाणिक आयुर्वेद को सुलभ बनाने के मिशन से हुआ था। डॉक्टरों और वैज्ञानिकों की एक टीम शामिल हुई।",
  },
  "Timeline 3 Title": { en: "Innovation Meets Tradition (2018)", hi: "नवाचार और परंपरा का मिलन (2018)" },
  "Timeline 3 Desc": {
    en: "We established our state-of-the-art facility where traditional preparation methods meet modern technology and quality control.",
    hi: "हमने अपनी अत्याधुनिक सुविधा स्थापित की जहां पारंपरिक तैयारी के तरीके आधुनिक तकनीक और गुणवत्ता नियंत्रण से मिलते हैं।",
  },
  "Timeline 4 Title": { en: "Trusted Nationwide (2024)", hi: "देश भर में भरोसेमंद (2024)" },
  "Timeline 4 Desc": {
    en: "Today, we proudly serve 50,000+ happy customers across the country with 100+ authentic Ayurvedic products for complete wellness.",
    hi: "आज, हम पूरे देश में 50,000+ खुश ग्राहकों को संपूर्ण स्वास्थ्य के लिए 100+ प्रामाणिक आयुर्वेदिक उत्पादों के साथ गर्व से सेवा प्रदान करते हैं।",
  },
  ...
  "Final CTA Subtitle": {
    en: "Join thousands of satisfied customers who have transformed their health with TulsiVeda's authentic, natural, and scientifically-backed Ayurvedic wellness products.",
    hi: "उन हजारों संतुष्ट ग्राहकों में शामिल हों जिन्होंने तुलसीवेद के प्रामाणिक, प्राकृतिक और वैज्ञानिक रूप से समर्थित आयुर्वेदिक उत्पादों के साथ अपने स्वास्थ्य को बदला है।",
  },
